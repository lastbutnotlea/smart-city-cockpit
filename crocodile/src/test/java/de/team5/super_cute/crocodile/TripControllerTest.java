...
public class TripControllerTest {
  ...
  public void testTripController() throws Exception {
    ...
    Line l1 = new LineBuilder().name("U6").color(Color.blue).stops(s2, s1).travelTime(0, 2).type(EVehicleType.SUBWAY).build();
    Line l2 = new LineBuilder().name("S1").color(Color.cyan).stops(s3, s1).travelTime(0, 3).type(EVehicleType.SUBWAY).build();
